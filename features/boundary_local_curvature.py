#adapted from chrometrics https://github.com/GVS-Lab/chrometrics/blob/main/nmco/nuclear_features/boundary_local_curvature.py
#used polar coordinate equation to calculate the radius of the circumcircle
...
from features.utils.utils import generate_max_z
